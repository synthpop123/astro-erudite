...
description: 'OS software supply chain landscape and vulnerability tracking'
date: 2023-06-16
tags: ['linux', 'security', 'supply chain', 'visualization']
...
![Ubuntu 22.04 操作系统软件供应链全景图](images/dep.jpg)
...
![modularity-report.png](images/modularity-report.png)
...
![libghc-cluster.jpg](images/libghc-cluster.jpg)
...
![vulnerabilities-amount.png](images/vulnerabilities-amount.png)
